...
- [Range-Doppler Model（RD模型）](#range-doppler-modelrd模型)
  - [公式总览](#公式总览)
  - [公式推导](#公式推导)
    - [距离方程](#距离方程)
    - [多普勒方程](#多普勒方程)
  - [多普勒效应](#多普勒效应)
    - [1.观察者移动，声源不动](#1观察者移动声源不动)
    - [2.声源移动，观察者不动](#2声源移动观察者不动)
...
\begin{aligned}
    \Delta f =& f - f_0 \\
             =& (\frac{c+w'}{c-w'}-1)f_0 \\
             =& \frac{2w'}{c-w'}f_0 \\
       \approx&  \frac{2w'}{\lambda} \rArr \frac{2}{\lambda}\cdot \frac{dR}{dt}
\end{aligned}
$$
